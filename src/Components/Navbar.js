...
Update Item</button></Link>
  ...
  <circle cx="8" cy="4.5" r="1"/>
              ...
              <li className="nav-item">
                <Link className="" to={"/verify"}><button className="btn btn-sm btn-primary">
                <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="mb-1 mr-1 bi bi-patch-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
