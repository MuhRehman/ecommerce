...
postData = () => {
    ...
    let data = {identifier:this.state.username,password:this.state.password};
    ...
    /////  2)  first Tell the user about successful login.


    this.setState({alertAppear : true});
    this.setState({alertMsg : "Welcome you Login Successfully.!"});
    this.setState({alertType : "success"});
  
    //3 -- 4)  save user and jwt  //// we rather chose to inform the APP
...
onSubmit = (e)=>{
    ...
    render () {
        ...
        return (
           ...
           {
    this.state.alertAppear == false ? <Form 
             noValidate 
            ...
            onSubmit={this.onSubmit}>
                ...
                <Form.Group>
                    ...
                    <input required type="input" className="form-control" name="username" 
                    onChange={(e)=>{this.setState({[e.target.name] : e.target.value})}} placeholder="Enter email" />
